  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (id) {
        ...
        // Get existing contents to compare
        const existingContents = await flashcardService.getFlashcardContentsById(id);
        ...
        const deletedContents = existingContents.filter(
